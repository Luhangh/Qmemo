...
public class NoteDao extends AbstractDao<Note, String> {
    ...
    public static class Properties {
        ...
        public final static Property MotifyTime = new Property(4, String.class, "motifyTime", false, "MOTIFY_TIME");
    ...
    public Note readEntity(Cursor cursor, int offset) {
        Note entity = new Note( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // motifyTime
    ...
    public void readEntity(Cursor cursor, Note entity, int offset) {
        ...
        entity.setMotifyTime(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
